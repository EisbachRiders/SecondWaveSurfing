...
I started Van der Waal with an old friend, Afonso. We have know each other since we were kids and as he is working in production, so I started to talk with him about my idea. So we naturally started this together.

<ImageContainer
  img1={imgVanDerWaalTeam}
  alt1="Martim and the Van der Waal Team"
  caption1="Martim and the Van der Waal Team"
/>
...
I can't tell you everything (hehe) but we started to work with some existing products on the market. Later, when Van der Waal started to sell, we made a partnership with a factory in Europe to produce to us what we were aiming for.
